...
public class AddProperty {
	...
	public Window addNewPropertyBox(JackrabbitExplorer jackrabbitExplorer) {
	    ...
	    class AddPropertySubmitValuesHandler implements SubmitValuesHandler {  
	    	...
	    	public AddPropertySubmitValuesHandler(JackrabbitExplorer jackrabbitExplorer) {
	    	...
	    	public void onSubmitValues(com.smartgwt.client.widgets.form.events.SubmitValuesEvent event) {
	        	if (addNewPropForm.validate()) {
		        	...
		        	JackrabbitExplorer.service.addNewProperty(path, newPropName.getValue().toString(), newPropValue.getValue().toString(),
	    ...
	    class AddPropertyButtonHandler implements ClickHandler {  
	    	private JackrabbitExplorer jackrabbitExplorer;
	    	public AddPropertyButtonHandler(JackrabbitExplorer jackrabbitExplorer) {
	    		this.jackrabbitExplorer = jackrabbitExplorer;
	    	}
