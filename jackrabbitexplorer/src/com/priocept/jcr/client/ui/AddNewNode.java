...
import com.priocept.jcr.client.callback.AvailableNodeTypesServiceCallback;
import com.priocept.jcr.client.callback.CRUDServiceCallback;
import com.priocept.jcr.client.fileupload.Upload;
import com.priocept.jcr.client.fileupload.UploadListener;
...
public class AddNewNode {
	...
	public Window addNewNodeBox(JackrabbitExplorer jackrabbitExplorer) {
	    ...
	    class AddNodeSubmitValuesHandler implements SubmitValuesHandler {  
	    	...
	    	public AddNodeSubmitValuesHandler(JackrabbitExplorer jackrabbitExplorer) {
	    	...
	    	public void onSubmitValues(com.smartgwt.client.widgets.form.events.SubmitValuesEvent event) {
	        	if (addNewNodeForm.validate()) {
	        		String path = JackrabbitExplorer.cellMouseDownTreeGrid.getSelectedRecord().getAttribute("path");
	        		JackrabbitExplorer.showLoadingImg();
	        		JackrabbitExplorer.service.addNewNode(path, newNodeName.getValue().toString(), newNodeType.getValue().toString(),
	    ...
	    class AddNodeButtonHandler implements ClickHandler {  
	    	private JackrabbitExplorer jackrabbitExplorer;
	    	public AddNodeButtonHandler(JackrabbitExplorer jackrabbitExplorer) {
	    		this.jackrabbitExplorer = jackrabbitExplorer;
	    	}
	    ...
	    class CancelAddNodeButtonHandler implements ClickHandler {  
	        public void onClick(ClickEvent event) {  
				...
				JackrabbitExplorer.service.addNewNode("", "", "","", true, new AsyncCallback<String>() {
					@Override
