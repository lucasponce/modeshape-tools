...
public class Details {
	...
	public TabSet createDetails(JackrabbitExplorer jackrabbitExplorer) {
		...
		class GoToSubmitValuesHandler implements SubmitValuesHandler {
	    	...
	    	public GoToSubmitValuesHandler(JackrabbitExplorer jackrabbitExplorer) {
		...
		class RenameSubmitValuesHandler implements SubmitValuesHandler {
	    	private JackrabbitExplorer jackrabbitExplorer;
	    	public RenameSubmitValuesHandler(JackrabbitExplorer jackrabbitExplorer) {
	    		this.jackrabbitExplorer = jackrabbitExplorer;
	    	}
			public void onSubmitValues(com.smartgwt.client.widgets.form.events.SubmitValuesEvent event) {
					...
					SC.confirm("Are you sure you want to rename node to "
						...
						public void execute(Boolean value) {
							if (value != null && !value.equals("")) {
								String path = JackrabbitExplorer.cellMouseDownTreeGrid
										.getSelectedRecord().getAttribute("path");
								JackrabbitExplorer.showLoadingImg();
								JackrabbitExplorer.service.renameNode(path, nameTxt.getValue()
		...
		class AddNodeButtonHandler implements ClickHandler {
			...
			AddNodeButtonHandler(JackrabbitExplorer jackrabbitExplorer) {
				this.jackrabbitExplorer = jackrabbitExplorer;
			}
		...
		class AddPropertyButtonHandler implements ClickHandler {
			JackrabbitExplorer jackrabbitExplorer = null;
			AddPropertyButtonHandler(JackrabbitExplorer jackrabbitExplorer) {
				this.jackrabbitExplorer = jackrabbitExplorer;
			}
			public void onClick(ClickEvent event) {
