package com.priocept.jcr.client.ui;

import com.priocept.jcr.client.JackrabbitExplorer;
import com.priocept.jcr.client.callback.SearchServiceCallback;
...
public class SearchTab {
	...
	public Tab searchTab(JackrabbitExplorer jackrabbitExplorer) {
	...
	private Tab fullTextSearchTab(JackrabbitExplorer jackrabbitExplorer) {
...
//		searchFullTxt.setValidators(regExpValidator);
	    ...
	    class SearchFullTextSubmitValuesHandler implements SubmitValuesHandler {  
	    	...
	    	public SearchFullTextSubmitValuesHandler(JackrabbitExplorer jackrabbitExplorer) {
	    	...
	    	public void onSubmitValues(com.smartgwt.client.widgets.form.events.SubmitValuesEvent event) {
					if (searchFullTextForm.validate()) {
						JackrabbitExplorer.showLoadingImg();
						JackrabbitExplorer.service.fullTextSearch(searchFullTxt.getValue().toString(),
	...
	private Tab xpathSearchTab(JackrabbitExplorer jackrabbitExplorer) {
	    ...
	    class SearchXpathSubmitValuesHandler implements SubmitValuesHandler {  
	    	private JackrabbitExplorer jackrabbitExplorer;
	    	public SearchXpathSubmitValuesHandler(JackrabbitExplorer jackrabbitExplorer) {
	    		this.jackrabbitExplorer = jackrabbitExplorer;
	    	}
	    	public void onSubmitValues(com.smartgwt.client.widgets.form.events.SubmitValuesEvent event) {
	    		if (searchXpathForm.validate()) {
	    			JackrabbitExplorer.showLoadingImg();
	    			JackrabbitExplorer.service.xpathSearch(searchXpathTxt.getValue().toString(),new SearchServiceCallback(jackrabbitExplorer));
	    		}
	      }  
	    };
	...
	private Tab sqlSearchTab(JackrabbitExplorer jackrabbitExplorer) {
	    ...
	    class SearchSqlSubmitValuesHandler implements SubmitValuesHandler {  
	    	private JackrabbitExplorer jackrabbitExplorer;
	    	public SearchSqlSubmitValuesHandler(JackrabbitExplorer jackrabbitExplorer) {
	    		this.jackrabbitExplorer = jackrabbitExplorer;
	    	}
	    	public void onSubmitValues(com.smartgwt.client.widgets.form.events.SubmitValuesEvent event) {
	    		if (searchSqlForm.validate()) {
	    			JackrabbitExplorer.showLoadingImg();
	    			JackrabbitExplorer.service.sqlSearch(searchSqlTxt.getValue().toString(), new SearchServiceCallback(jackrabbitExplorer));
	    		}
	      }  
	    };
